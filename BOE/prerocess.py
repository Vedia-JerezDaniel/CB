...
df = boe[['date','Index','b','Rate','RateDecision']]
df = df.fillna(0)
...
df.to_excel("E:\\GitRepo\\CB speeches\\data\\boe_pre.xlsx", engine='xlsxwriter')
...
boe.to_excel("E:\\GitRepo\\CB speeches\\data\\sent_BOE.xlsx",sheet_name="BOE", engine="xlsxwriter")